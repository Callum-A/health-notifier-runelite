package net.runelite.client.plugins.healthnotification;
...
public class HealthNotificationPlugin extends Plugin
{
    @Inject
    ...
    @Inject
    private HealthNotificationConfig healthNotificationConfig;
    ...
    @Provides
    public HealthNotificationConfig getConfig(ConfigManager configManager)
    {
        return configManager.getConfig(HealthNotificationConfig.class);
    }
